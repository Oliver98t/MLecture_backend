...
public class Transcribe
{
    ...
    public class TranscribeResponse
    {
        ...
        public required string ResultsMessage { get; set; }
    }
    ...
    {
        string youtubeUrl = message.MessageText;
        _logger.LogInformation($">>>>>>>>>>>>>{message.MessageText}");
        string transcript = await TranscriptAPI.TranscribeCall(youtubeUrl);
        _logger.LogInformation(transcript);
        await AddTranscriptToDB(transcript);
        return new TranscribeResponse
        {
            ResultsMessage = transcript,
        };
    }
}